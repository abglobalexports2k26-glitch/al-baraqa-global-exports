  ...
  return (
    <section className="who-we-are">
      <div className="who-we-are-container">
        <div className="who-we-are-image" data-aos="fade-right" data-aos-duration="1200">
          <img
        ...
        <div className="who-we-are-content">
          <div className="section-header" data-aos="fade-left" data-aos-delay="100">
            <h2>Who We Are</h2>
          </div>
      ...
      <div className="stats-grid">
        <div className="stat-item" data-aos="zoom-in" data-aos-delay="500">
          ...
          <h4>Chartered Accountant Brain</h4>
